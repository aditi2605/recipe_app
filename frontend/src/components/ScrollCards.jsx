...
export default function ScrollCards({ onViewRecipe }) {
    ...
    return (
        <div className="w-full px-4 md:px-10 py-12 space-y-16">
            {/* Recommended Recipes */}
            <section>
                <h2 className="text-2xl font-bold text-green-800 mb-4">Recommended Recipes 🥙</h2>
                        ...
                        {Array.isArray(recipes) && recipes.map((item) => (
                            <motion.div
                                ...
                                <div className="relative w-full h-56 sm:h-64">
                                    ...
                                    {/* Tag */}
                                    <div className="absolute top-3 left-3 bg-green-600/90 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-md flex items-center gap-1">
                                    🌟 Recommended
                                    </div>

                                    {/* Cooking Time */}
                                    <div className="absolute top-3 right-3 bg-white text-green-800 text-xs font-semibold px-2 py-1 rounded-full shadow flex items-center gap-1">
                                    ⏱ {item.cooking_time}
                                    </div>
                                </div>
            ...
            {/* Trending Recipes */}
            <section>
                <h2 className="text-2xl font-bold text-green-800 mb-4">Trending Recipes 📸</h2>
                <div className="overflow-x-auto pb-4">
                    <div className="flex space-x-4">
                          {Array.isArray(recipes) && recipes.map((item) => (
                            <motion.div
